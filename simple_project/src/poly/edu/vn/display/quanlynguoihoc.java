...
int index = 0;
 ...
 public  boolean check(){
        ...
        else if (!(txtma.getText()).matches("NH[0-9]{1,5}")) {
    ...
    void load() { 
     ...
     NguoiHoc getModel() { 
       NguoiHoc model = new NguoiHoc(); 
        ...
        void sendEmail() {
    final String user = "khongbietthang0@gmail.com";
    final String pass = "fcbm augf deuw czcr";
        ...
        try {
            ...
            message.setRecipient(Message.RecipientType.TO, new InternetAddress("username042111@gmail.com"));
            message.setRecipient(Message.RecipientType.CC, new InternetAddress("username042111@gmail.com"));
            message.setSubject("Chào mừng bạn đã đăng ký thành công khóa học của Lập Trình City!");

            // Tạo một multipart message để hỗ trợ việc đính kèm file
            Multipart mul = new MimeMultipart();

            // Thêm phần nội dung của email
            BodyPart messBody = new MimeBodyPart();
            messBody.setText("Giúp cho bạn có được bức tranh đầy đủ & chi tiết của một lộ trình học tiếng Anh thông minh.\n" +
                "Giúp bạn có được phương pháp đúng để làm chủ tiếng Anh nhanh nhất và hiệu quả nhất.\n" +
                "Giúp bạn nhanh chóng chinh phục tiếng Anh để vươn lên những nấc thang mới trong sự nghiệp và cuộc sống!");
            mul.addBodyPart(messBody);

            // Đính kèm file nếu có
//            if (txt_file.getText() != null && !txt_file.getText().isEmpty()) {
//                try {
//                    MimeBodyPart attachBody = new MimeBodyPart();
//                    attachBody.attachFile(new File(filePath));
//                    mul.addBodyPart(attachBody);
...
//            }
            ...
            JOptionPane.showMessageDialog(this, "Email Message Sent Successfully");
...
////        message.setRecipient(Message.RecipientType.CC, new InternetAddress(txtemail.getText()));
//        message.setSubject("Chào mừng bạn đã đăng ký thành công khóa học của Lập Trình City!");
//        message.setText("Giúp cho bạn có được bức tranh đầy đủ & chi tiết của một lộ trình học tiếng Anh thông minh.\n" +
//                "Giúp bạn có được phương pháp đúng để làm chủ tiếng Anh nhanh nhất và hiệu quả nhất.\n" +
//                "Giúp bạn nhanh chóng chinh phục tiếng Anh để vươn lên những nấc thang mới trong sự nghiệp và cuộc sống!");
//
//        // Send message
