 ...
 * @author Đăng Ngô
 */
public class Quanlinhanvienquantri1 extends javax.swing.JFrame {
int index = 0;  
  NhanvienDao dao = new NhanvienDao(); 
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(Quanlinhanvienquantri1.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new Quanlinhanvienquantri1().setVisible(true);
            }
        });
    }
